...
description: header file for led lighting, registers definitions
...
typedef struct 
{
	...
	volatile unsigned int CSCDR3;			// 20C403C
	volatile unsigned int RESERVED_1[2];	// 20C4040, 20C4044    Using reserved fields for address continuation
	volatile unsigned int CDHIPR; 			// 20C4048
	...
	volatile unsigned int CCGR6;			// 20C4080
	volatile unsigned int RESERVED_3[1];	// 20C4084				Using reserved fields for address continuation
	volatile unsigned int CMEOR;			// 20C4088
} CCM_Type; 
